...
export function createSwarmIntegrationSetupRuntime(deps) {
  ...
  const updateInfoPanel = createInfoPanelRuntime({
    ...
    huntingAvailabilityRowEl: deps.interactionContext.huntingAvailabilityRowEl,
    huntingAvailabilityLabelEl: deps.interactionContext.huntingAvailabilityLabelEl,
    huntingAvailabilityBarFillEl: deps.interactionContext.huntingAvailabilityBarFillEl,

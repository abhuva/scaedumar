...
export function createRenderPipelineAssemblyRuntime(deps) {
  return {
    ...
    defaultTerrainApronSettings: deps.defaultTerrainApronSettings,
    getTerrainApronSettings: deps.getTerrainApronSettings,
    ...
    isStructureRenderVisible: deps.isStructureRenderVisible,
    getAgentSpriteRenderSnapshot: deps.getAgentSpriteRenderSnapshot,
    isAgentSpriteRenderVisible: deps.isAgentSpriteRenderVisible,

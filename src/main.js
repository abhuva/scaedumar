...
const uniforms = {
  ...
  uDetailMacroColor: gl.getUniformLocation(program, "uDetailMacroColor"),
  ...
  uDetailStartPxPerMeter: gl.getUniformLocation(program, "uDetailStartPxPerMeter"),
  uDetailFullPxPerMeter: gl.getUniformLocation(program, "uDetailFullPxPerMeter"),
  uDetailWaterSuppression: gl.getUniformLocation(program, "uDetailWaterSuppression"),
  uDetailRockSlopeStart: gl.getUniformLocation(program, "uDetailRockSlopeStart"),
  uDetailRockSlopeEnd: gl.getUniformLocation(program, "uDetailRockSlopeEnd"),
  uDetailRockNoiseScale: gl.getUniformLocation(program, "uDetailRockNoiseScale"),
  uDetailRockNoiseStrength: gl.getUniformLocation(program, "uDetailRockNoiseStrength"),
  uDetailDirtMicroRect: gl.getUniformLocation(program, "uDetailDirtMicroRect"),
  uDetailRockMicroRect: gl.getUniformLocation(program, "uDetailRockMicroRect"),
  uDetailDirtMacroRect: gl.getUniformLocation(program, "uDetailDirtMacroRect"),
  uDetailRockMacroRect: gl.getUniformLocation(program, "uDetailRockMacroRect"),
  uDetailMicroScales: gl.getUniformLocation(program, "uDetailMicroScales"),
  uDetailMacroScales: gl.getUniformLocation(program, "uDetailMacroScales"),
...
detailAtlasRuntime = createDetailAtlasRuntime({
  ...
  macroColorTex: detailMacroColorTex,
});

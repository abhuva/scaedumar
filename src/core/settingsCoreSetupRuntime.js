...
export function createSettingsCoreSetupRuntime(deps) {
  ...
  const settingsCompatRuntime = {
    ...
    serializeDetailSettingsCompat: (...args) => callCompat("serializeDetailSettingsCompat", ...args),
    applyDetailSettingsCompat: (...args) => callCompat("applyDetailSettingsCompat", ...args),
    serializeApronSettingsCompat: (...args) => callCompat("serializeApronSettingsCompat", ...args),
    applyApronSettingsCompat: (...args) => callCompat("applyApronSettingsCompat", ...args),
    serializeCameraSettingsCompat: (...args) => callCompat("serializeCameraSettingsCompat", ...args),
    applyCameraSettingsCompat: (...args) => callCompat("applyCameraSettingsCompat", ...args),
    ...
    serializeDetailSettings: (...args) => callCanonical("serializeDetailSettings", ...args),
    applyDetailSettings: (...args) => callCanonical("applyDetailSettings", ...args),
    serializeApronSettings: (...args) => callCanonical("serializeApronSettings", ...args),
    applyApronSettings: (...args) => callCanonical("applyApronSettings", ...args),
    serializeCameraSettings: (...args) => callCanonical("serializeCameraSettings", ...args),
    applyCameraSettings: (...args) => callCanonical("applyCameraSettings", ...args),

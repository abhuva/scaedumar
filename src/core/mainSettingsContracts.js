...
export const DEFAULT_SWARM_SETTINGS = {
  ...
  followAgentZoomSmoothing: 0.12,
  followCameraPositionSmoothing: 0.12,
...
export const DEFAULT_SLIME_SETTINGS = {
  ...
  availabilityUpdateTickInterval: 10,
  plantStockSyncTickInterval: 120,
  sensorDistance: 14,
  sensorAngleDeg: 45,
  sensorSize: 1,
  sensorNoise: 0.02,
  ...
  plantFloor: 0.25,
  plantEatAmount: 5,
  plantEatTickInterval: 10,
  plantRegenAmount: 1,
  plantRegenTickInterval: 5,
  huntingFleeSteps: 100,
  huntingFleeWeight: 80,
  huntingFleeRadius: 120,
  brushRadius: 60,

export function bindCanvasControls(deps) {
  ...
  function isUiTarget(target) {
    ...
    return Boolean(target.closest(".topic-panel, .swarm-stats-panel, .movement-status-panel, .route-waypoint-menu, .inventory-panel, .wiki-panel, .journal-panel, .gameplay-hud"));
  }

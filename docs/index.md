<div class="hero-wrap">
  <img src="./title-logo.jpg" alt="Scaedumar title art" class="hero-logo" />
  <p class="hero-kicker">A mythic world prototype</p>
  <h1 class="hero-title">Scaedumar</h1>
  <p class="hero-subtitle">Top-down terrain rendering with atmospheric lighting, living simulation, and map-driven gameplay systems.</p>
...
<div class="feature-grid">
  <a class="feature-card" href="./ARCHITECTURE.md">
    <h3>Engine Core</h3>
    <p>WebGL2 terrain pipeline, map-sidecar settings, and modular runtime ownership.</p>
  </a>
  <a class="feature-card" href="./visual-baselines/README.md">
    <h3>Visual Baselines</h3>
    <p>Reference captures and smoke-validation snapshots for rendering consistency.</p>
  </a>
  <a class="feature-card" href="./plans+setups/SMOKE_CHECKLIST.md">
    <h3>Setup & Validation</h3>
    <p>Runbook for local verification, smoke checks, and release-adjacent readiness.</p>
  </a>
  <a class="feature-card" href="./notes/Ideas.md">
    <h3>Worldbuilding Notes</h3>
    <p>Creative direction and systems ideation shaping the broader game vision.</p>
  </a>
</div>
